...
if (real_graph ==1){
      ...
      // if (count_graph ==0){
        ...
        //170sx,171.25sy, 170sx,66.89sy,920sx,171.25sy
      ...
      if (x_con>750) {
        if ((171.2-concentration*0.7)<(171.25-y_con)){
          ...
          //(170sx,66.89sy,    920sx,171.25sy,920sx,171.25sy)
          console.log('hh')
...
// if (count_graph ==0){
        ...
        let slope = round((171.25-(171.2-concentration*0.7))/((170+x_con+1)-170)*(40/0.14))
   
        if (x_con<750) {
          rect(170*s_x,298.75*s_y,x_con*s_x,slope*s_y)
        } else if (x_con>=750){
          ...
          if ((171.2-concentration*0.7)<(171.25-y_con)){
            slope = round((171.25-(171.2-concentration*0.7)-y_con)/((170+x_con+1)-170)*(40/0.14))
            rect(170*s_x,298.75*s_y,x_con*s_x,slope*s_y)
            console.log('hehe')
...
changetest= (v) => {
  ...
  document.getElementById("test_1").value=scatter_n
  document.getElementById("test_2").value=scatter_n
}